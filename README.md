...
```bash
bash <(curl -sSL "https://raw.githubusercontent.com/Supernich/create-service/main/create-service.sh")
```

Or with wget:

```bash
bash <(wget -qO- "https://raw.githubusercontent.com/Supernich/create-service/main/create-service.sh")
```
